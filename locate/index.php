...
<body>
    ...
    <div class="mb-4 h-10 bg-blue-600">
        <div class="container flex items-center justify-start px-4 min-h-full overflow-x-auto sm:mx-auto sm:overflow-auto font-display ">
            ...
            <a href="https://2kmfromhome.com/2km" class="mr-3 text-xs sm:text-sm md:mr-5 text-white font-bold ">2KM</a>
            <a href="https://2kmfromhome.com/5km" class="mr-3 text-xs sm:text-sm md:mr-5 text-white font-bold ">5KM</a>
            <a href="https://2kmfromhome.com/10km" class="mr-3 text-xs sm:text-sm md:mr-5 text-white font-bold ">10KM</a>
            <a href="https://2kmfromhome.com/15km" class="mr-3 text-xs sm:text-sm md:mr-5 text-white font-bold ">15KM</a>
